...
const resizePlugins = () => {
  ...
  if (window.innerWidth < 1025) {
    ...
    if (footerResponsive !== null) {
      if (!footerResponsive.classList.contains('footer')) {
        footerResponsive.classList.add('sidebar-mini', 'on-resize')
      }
    }
...
// const sayHello = require('https://cdn.datatables.net/2.1.8/js/dataTables.js');
